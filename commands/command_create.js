...
const command_create=async(channel,author)=>{
    try {
        ...
        embededMessage.setURL(`${process.env.FRONTENDAPI}dashboard/null/${entryId}/${author.id}`);
